...
<?php
	...
	if (isset($_POST["spremi"])) {
		...
		/*if (!empty($tipPostavljene) || !empty($modelPostavljene) || !empty($serijskiPostavljene)) {*/
...
?>
	...
	<div class="index">
	<form action="dodatna_oprema_ukljucenje.php" method="post" onsubmit="return checkforblank();">
