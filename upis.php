...
<?php
	...
	/*if (($upisParice == da && $promjenaParice == da) || ($upisPorta == da && $promjenaPorta == da)) {
		echo "U istom trenutku upis i promjena za port ili paricu ne mogu biti odabrani.";
		echo "<meta http-equiv=\"refresh\" content=\"0; index.php\"/>";
	}elseif (!empty($brojKartice) && !empty($datum) && !empty($zadatak) && !empty($korisnik) && !empty($brojTelefona) && !empty($asset) && !empty($adresa) && !empty($kontakt) && !empty($zabiljeska)) {*/
		...
		/*}// if !empty
			...
			echo '<h2>Nisu upisani broj kartice i datum.</h2>';
			echo "<meta http-equiv=\"refresh\" content=\"0; index.php\"/>"; 
		}*/
