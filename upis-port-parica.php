...
<div class="omotac">
	...
	<?php
		...
		if (isset($_POST["spremi"])) {
			...
			/*if (!empty($tipPreuzete) || !empty($modelPreuzete) || !empty($serijskiPreuzete) || !empty($tipPostavljene) || !empty($modelPostavljene) || !empty($serijskiPostavljene) || !empty($aktivnaPP) || !empty($staraPP) || !empty($novaPP) || !empty($aktivniDslam) || !empty($aktivniPort) || !empty($aktivniMr) || !empty($aktivnaPozicija) || !empty($noviDsalm) || !empty($noviPort) || !empty($noviMr) || !empty($novaPozicija) || !empty($stariDslam) || !empty($stariPort) || !empty($stariMr) || !empty($staraPozicija)) {*/
