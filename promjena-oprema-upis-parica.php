...
<div class="omotac">
	<?php
		...
		if (isset($_POST["spremi"])) {
			...
			/*if (!empty($tipPreuzete) || !empty($modelPreuzete) || !empty($serijskiPreuzete) || !empty($tipPostavljene) || !empty($modelPostavljene) || !empty($serijskiPostavljene) || !empty($aktivnaPP) ) {*/
...
<div class="head">
	...
	<div class="index">
	<form action="promjena-oprema-upis-parica.php" method="post">
