	...
	if (isset($_POST["spremi"])) {
		...
		$user = $_SESSION['user_username'];
			...
			//	if ($dodatnaOprema == ne){
					...
					$upisOpreme = mysql_query("INSERT INTO `ukljucenje` (`broj_kartice`, `tip`, `model`, `kompanija`, `serijski`, `dodatna_oprema`, `user`) VALUES ('$brojKartice', '$tipPostavljene', '$modelPostavljene', '$kompanijaPostavljene', '$serijskiPostavljene','$dodatnaOprema', '$user')") or die(mysql_error());
				...
				/*}elseif ($dodatnaOprema == da) {
					...
					$upisOpreme = mysql_query("INSERT INTO `ukljucenje` (`broj_kartice`, `tip_postavljene`, `model_postavljene`, `kompanija_postavljene`, `serijski_postavljene`, `dodatna_oprema`, `user`) VALUES ('$brojKartice', '$tipPostavljene', '$modelPostavljene', '$kompanijaPostavljene', '$serijskiPostavljene','$dodatnaOprema', '$user')") or die(mysql_error());
...
<div class="head">
	...
	<div class="index">
	<form action="oprema_ukljucenje.php" method="post" onsubmit="return checkforblank();">
