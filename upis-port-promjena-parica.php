...
<head>
	...
	<script type="text/javascript">
			...
			function checkforblank(){
				...
				if ((document.getElementById('broj_kartice').value == "") || (document.getElementById('stara_pp').value == "") || (document.getElementById('nova_pp').value == "") || (document.getElementById('aktivni_dslam').value == "") || ((document.getElementById('aktivni_port').value == "") && (document.getElementById('aktivni_mr').value == ""))) {

						praznaForma += "Nisu uneseni svi potrebni podaci. \n";
				}
...
<div class="omotac">
	<?php
		...
		if (isset($_POST["spremi"])) {
			...
			/*if (!empty($staraPP) || !empty($novaPP) || !empty($aktivniDslam) || !empty($aktivniPort) || !empty($aktivniMr) || !empty($aktivnaPozicija)) {*/
...
<div class="head">
	...
	<div class="index">
	<form action="upis-port-promjena-parica.php" method="post" onsubmit="return checkforblank();">
