...
<div class="omotac">
	<?php
		...
		if (isset($_POST["spremi"])) {
			...
			/*if (!empty($tipPostavljene) || !empty($modelPostavljene) || !empty($serijskiPostavljene) || !empty($aktivnaPP) ||  !empty($aktivniDslam) || !empty($aktivniPort) || !empty($aktivniMr) || !empty($aktivnaPozicija)) {*/
				...
				/*}elseif ($dodatnaOprema == da) {
					...
					$upisPariceQuery = "INSERT INTO `parica_aktivna` (`broj_kartice`, `aktivna_pp`, `aktivna_pp_pozicija`) VALUES ('$brojKartice', '$aktivnaPP', '$aktivnaPPpozicija')";
...
<div class="head">
	...
	<div class="index">
	<form action="ukljucenje-oprema-unos-parica-port.php" method="post">
			...
			<p>Centrala:<input class = "input_text" type="text" name="aktivna_pp_pozicija" id="aktivna_pp_pozicija"></p><br>
