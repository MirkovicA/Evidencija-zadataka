...
<body>
	<div class="omotac">
		...
		<div class="index">
			<form action="oprema-parica-port-upis.php" method="post" onsubmit="return checkforblank();">
