...
<?php
	...
	if (isset($_POST["spremi"])) {
		...
		/*if (!empty($noviDsalm) || !empty($noviPort) || !empty($noviMr) || !empty($novaPozicija) || !empty($stariDslam) || !empty($stariPort) || !empty($stariMr) || !empty($staraPozicija)) {*/
		...
		/*}else
		echo '<p>Niste unijeli podatke. Pokusajte ponovno. </p>';*/
