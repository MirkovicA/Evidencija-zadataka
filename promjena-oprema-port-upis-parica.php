...
<body>
	...
	<?php
		...
		if (isset($_POST["spremi"])) {
			...
			/*if (!empty($tipPreuzete) || !empty($modelPreuzete) || !empty($serijskiPreuzete) || !empty($tipPostavljene) || !empty($modelPostavljene) || !empty($serijskiPostavljene) || !empty($aktivnaPP) || !empty($noviDsalm) || !empty($noviPort) || !empty($noviMr) || !empty($novaPozicija) || !empty($stariDslam) || !empty($stariPort) || !empty($stariMr) || !empty($staraPozicija)) {*/
