		...
		if (isset($_POST['pregled'])) {
			...
			while ($pregled = mysql_fetch_array($queryPregled)) {
				...
				if ($pregled["promjena_oprema"] == da) {
					...
					while ($pregledPodaci = mysql_fetch_array($pregled)) {
						//if ($pregledPodaci["dodatna_oprema"] == da) {
							echo "<form action=pregled.php method=post>";
							echo '<p>Broj kartice: '.'<input class = "input_text" type="text" name="broj_kartice" value="'.$pregledPodaci["broj_kartice"].'"></p>';
							echo '<p>Korisnik: '.'<input class = "input_text" type="text" name="korisnik" value="'.$pregledPodaci["korisnik"].'"></p>';
							echo '<p>Kontakt broj: '.'<input class = "input_text" type="text" name="kontakt" value="'.$pregledPodaci["kontakt"].'"></p>';
							...
							/*echo $id = $pregledPodaci["id"]+1;
							
							$pregledNovo = mysql_query("SELECT * FROM `oprema` WHERE oprema.id = '$id'") or die(mysql_error());

							if ($pregledNovo) {
								echo '<p>Tip preuzete opreme: '.'<input type="text" name="tip_preuzete" value="'.$pregledNovo["tip_preuzete"].'"></p>';
								echo '<p>Model preuzete opreme: '.'<input type="text" name="model_preuzete" value="'.$pregledNovo["model_preuzete"].'"></p>';
								echo '<p>Serijski broj preuzete opreme: '.'<input type="text" name="serijski_preuzete" value="'.$pregledNovo["serijski_preuzete"].'"></p>';
								echo '<p>Kompanija preuzete opreme: '.'<input type="text" name="kompanija_preuzete" value="'.$pregledNovo["kompanija_preuzete"].'"></p>';
								echo '<p>Tip postavljene opreme: '.'<input type="text" name="tip_postavljene" value="'.$pregledNovo["tip_postavljene"].'"></p>';
								echo '<p>Model postavljene opreme: '.'<input type="text" name="model_postavljene" value="'.$pregledNovo["model_postavljene"].'"></p>';
								echo '<p>Serijski broj postavljene opreme: '.'<input type="text" name="serijski_postavljene" value="'.$pregledNovo["serijski_postavljene"].'"></p>';
								echo '<p>Kompanija postavljene opreme: '.'<input type="kompanija_postavljene" value="'.$pregledNovo["kompanija_postavljene"].'"></p>';
							}*/
