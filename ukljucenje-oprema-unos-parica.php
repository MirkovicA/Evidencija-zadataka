...
<head>
	...
	<script type="text/javascript">
		...
		function checkforblank(){
			var praznaForma = "";
			if ((document.getElementById('broj_kartice').value == "") || (document.getElementById('tip_postavljene').value == "") || (document.getElementById('model_postavljene').value == "") || (document.getElementById('serijski_postavljene').value == "") || (document.getElementById('aktivna_pp').value == "") || (document.getElementById('aktivna_pp_pozicija'). value == "")) {
...
<div class="omotac">
	<?php
		...
		if (isset($_POST["spremi"])) {
			...
			/*if (!empty($tipPostavljene) || !empty($modelPostavljene) || !empty($serijskiPostavljene) || !empty($aktivnaPP)) {*/
...
<div class="head">
	...
	<div class="index">
	<form action="ukljucenje-oprema-unos-parica.php" method="post">
