...
<div class="omotac">
	...
	<?php
		...
		if (isset($_POST["spremi"])) {
			...
			/*if (!empty($tipPreuzete) || !empty($modelPreuzete) || !empty($serijskiPreuzete) || !empty($tipPostavljene) || !empty($modelPostavljene) || !empty($serijskiPostavljene) || !empty($aktivniDslam) || !empty($aktivniPort) || !empty($aktivniMr) || !empty($aktivnaPozicija) || !empty($noviDsalm) || !empty($noviPort) || !empty($noviMr) || !empty($novaPozicija) || !empty($stariDslam) || !empty($stariPort) || !empty($stariMr) || !empty($staraPozicija)) {*/
			...
			/*	}elseif ($dodatnaOprema == da) {
					...
					$upisDslamQuery = "INSERT INTO `dslam` (`broj_kartice`, `novi_dslam`, `novi_port`, `novi_mr`, `nova_pozicija`, `stari_dslam`, `stari_port`, `stari_mr`, `stara_pozicija`) VALUES ('$brojKartice', '$noviDsalm', '$noviPort', '$noviMr', '$novaPozicija', '$stariDslam', '$stariPort', '$stariMr', '$staraPozicija')";
